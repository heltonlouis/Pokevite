<template>
  <div class="container mt-4 text-body-secondary">
    <div class="card" style="margin-bottom: 100px">
      ...
      <div class="card-body">
        <h2>Aprendizado:</h2>
        <p>Muito show de bola este mini curso oferecido pelo Yuri, achei interessante deixar o video dele, pois é preciso divulgar seu trabalho. 
          Eu super recomendo quem queira aprender um pouco sobre Vue e Vite!</p>
        <hr>
        <h3>Tutorial</h3>
        <p>
          GitHub do Yuri: <a href="https://github.com/yurimarcon/Vite-pokedex" target="_blank" alt="Link do projeto no GitHub" >/Vite-pokedex</a>
        </p>
